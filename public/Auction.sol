...
contract Auction {
	...
	function Bid() public payable {
        ...
        uint256 bid_amount = bids[msg.sender].bid_amount + msg.value;
		require (bid_amount > currentPrice && msg.value >= 1);
	...
	function showUserBidded() public constant returns (uint256 _biddedAmount) {
	    _biddedAmount = bids[msg.sender].bid_amount;
	}
...
// 		require(now >= endTime && isEnded == false); This code was commented out due to debug convenience
		require(isEnded == false);
		isEnded = true;
